...
def simulacion(theta_sol, lados_poly = 20, rayos=300):        
    #Diseño concentrador
    ...
    for x in range(N_surf):
        ...
        #ultimo cuerpo a generar: el cielo
            ...
            rho = 0
            tau = 0
            x1, y1, x2, y2 = [-(W*1.2), max_alt_cielo, (W*1.2), max_alt_cielo]
...
factor_int, surface, x_y_flux = simulacion(80)
