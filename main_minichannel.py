...
def simulacion(theta_sol):        
    ...
    origen_abs = [[0,210]]    #arreglo con origen de los absorbedores 
    ...
    for x in range(N_surf):
        ...
        #ultimo cuerpo a generar: el cielo
            ...
            rho = 0
            tau = 0
            x1, y1, x2, y2 = [-(W*2), max_alt_cielo, (W*2), max_alt_cielo]
...
#    print ('El factor de interceptación es de ' + str(ray_interc))
